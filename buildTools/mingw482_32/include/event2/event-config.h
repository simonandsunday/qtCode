...
/* #undef _EVENT_HAVE_GETEGID */

/* Define to 1 if you have the `geteuid' function. */
/* #undef _EVENT_HAVE_GETEUID */
...
/* #undef _EVENT_HAVE_GETPROTOBYNUMBER */
